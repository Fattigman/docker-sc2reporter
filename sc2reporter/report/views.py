...
def variant(var_id):
    ...
    samples_with_variant = list(samples_with_variant)
    return render_template('variant.html', annotations=variant_annotations, samples=samples_with_variant, var_per_date=var_per_date, var_id=var_id, sample_ids= [x['sample_id'] for x in samples_with_variant])
