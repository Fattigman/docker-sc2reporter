...
Follow the two options described here:
  * [Development](https://github.com/genomic-medicine-sweden/docker-sc2reporter/blob/main/docs/development.md)
  * [Production](https://github.com/genomic-medicine-sweden/docker-sc2reporter/blob/main/docs/production.md)
