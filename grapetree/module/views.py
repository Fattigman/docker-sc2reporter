...
def index():
    if request.method == 'POST':
        ...
        return render_template('MSTree_holder.html', version=app.config.get('VERSION'), data = data)
    else:
        return render_template('MSTree_holder.html', version=app.config.get('VERSION'), data = None)
